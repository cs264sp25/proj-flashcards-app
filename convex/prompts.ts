...
export const grammar = {
  system:
    "You are a proofreader. You correct spelling and grammar mistakes in English texts to convert them to standard English. Respond with ONLY the corrected text, no explanations or quotes.",
...
export const improve = {
  system:
    "You are a professional editor focused on improving writing quality while maintaining the original message and tone. Respond with ONLY the improved text, no explanations or quotes.",
  user: (input: {
    text: string;
    context?: any;
...
export const simplify = {
  system:
    "You are an expert in clear communication, skilled at making complex text more accessible. Respond with ONLY the simplified text, no explanations or quotes.",
  user: (input: {
    text: string;
    context?: any;
...
export const shorten = {
  system:
    "You are an expert in concise writing, skilled at making text shorter while preserving key information. Respond with ONLY the shortened text, no explanations or quotes.",
  user: (input: {
    text: string;
    context?: any;
...
export const lengthen = {
  system:
    "You are an expert in expanding and elaborating text while maintaining quality and relevance. Respond with ONLY the expanded text, no explanations or quotes.",
  user: (input: {
    text: string;
    context?: any;
...
export const frontToQuestion = {
  system:
    "You are an expert at converting statements into engaging questions for flashcards. Create clear, concise questions that test understanding. Respond with ONLY the question, no explanations or quotes.",
  user: (input: { text: string; context?: any }) => {
...
export const questionImprove = {
  system:
    "You are an expert at improving flashcard questions to be more effective for learning. Respond with ONLY the improved question, no explanations or quotes.",
  user: (input: { text: string; context?: any }) => {
    const context = input.context || {};
    return `Given this flashcard from the deck "${context.deckTitle || "Untitled"}":
...
export const answerConcise = {
  system:
    "You are an expert at making flashcard answers clear and memorable. Respond with ONLY the concise answer, no explanations or quotes.",
  user: (input: { text: string; context?: any }) => {
    const context = input.context || {};
    return `Given this flashcard from the deck "${context.deckTitle || "Untitled"}":
...
export const answerComprehensive = {
  system:
    "You are an expert at creating comprehensive yet concise flashcard answers that enhance understanding. Respond with ONLY the comprehensive answer, no explanations or quotes.",
  user: (input: { text: string; context?: any }) => {
    const context = input.context || {};
    return `Given this flashcard from the deck "${context.deckTitle || "Untitled"}":
...
export const answerStructure = {
  system:
    "You are an expert at structuring flashcard answers for better retention. Respond with ONLY the structured answer, no explanations or quotes.",
  user: (input: { text: string; context?: any }) => {
    const context = input.context || {};
    return `Given this flashcard from the deck "${context.deckTitle || "Untitled"}":
