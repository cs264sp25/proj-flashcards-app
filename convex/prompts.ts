...
Always use these exact formats when referencing decks or cards. Do not include any additional text or formatting around the components.`,
  user: (input: z.infer<typeof chat.inputSchema>) => input.text,
};
...
export const grammar = {
  ...
  user: (input: z.infer<typeof grammar.inputSchema>) => {
...
export const improve = {
  ...
  user: (input: z.infer<typeof improve.inputSchema>) => {
...
export const simplify = {
  ...
  user: (input: z.infer<typeof simplify.inputSchema>) => {
...
export const shorten = {
  ...
  user: (input: z.infer<typeof shorten.inputSchema>) => {
...
export const lengthen = {
  ...
  user: (input: z.infer<typeof lengthen.inputSchema>) => {
...
export const frontToQuestion = {
  ...
  user: (input: z.infer<typeof frontToQuestion.inputSchema>) => {
...
export const questionImprove = {
  ...
  user: (input: z.infer<typeof questionImprove.inputSchema>) => {
    const context = input.context || {};
...
export const answerConcise = {
  ...
  user: (input: z.infer<typeof answerConcise.inputSchema>) => {
    const context = input.context || {};
...
export const answerComprehensive = {
  ...
  user: (input: z.infer<typeof answerComprehensive.inputSchema>) => {
    const context = input.context || {};
...
export const answerStructure = {
  ...
  user: (input: z.infer<typeof answerStructure.inputSchema>) => {
    const context = input.context || {};
...
export const custom = {
  ...
  user: (input: z.infer<typeof custom.inputSchema>) => {
    const context = input.context || {};
...
export const generateTitleFromCards = {
  ...
  user: (
    input: z.infer<typeof generateTitleFromCards.inputSchema> & {
...
export const generateDescriptionFromCards = {
  ...
  user: (
    input: z.infer<typeof generateDescriptionFromCards.inputSchema> & {
      cardSamples: CardSample[];
    },
  ) => {
    const cardContent = formatCardSamples(input.cardSamples);
...
export const generateTagsFromCards = {
  ...
  user: (
    input: z.infer<typeof generateTagsFromCards.inputSchema> & {
      cardSamples: CardSample[];
    },
  ) => {
    const cardContent = formatCardSamples(input.cardSamples);
...
export const generateTitleFromMessages = {
  ...
  user: (
    input: z.infer<typeof generateTitleFromMessages.inputSchema> & {
...
export const generateDescriptionFromMessages = {
  inputSchema: baseInputSchema.extend({
  ...
  user: (
    input: z.infer<typeof generateDescriptionFromMessages.inputSchema> & {
      messageSamples: MessageSample[];
    },
  ) => {
    const messageContent = formatMessageSamples(input.messageSamples);
...
export const generateTagsFromMessages = {
  inputSchema: baseInputSchema.extend({
  ...
  user: (
    input: z.infer<typeof generateTagsFromMessages.inputSchema> & {
      messageSamples: MessageSample[];
    },
  ) => {
    const messageContent = formatMessageSamples(input.messageSamples);
